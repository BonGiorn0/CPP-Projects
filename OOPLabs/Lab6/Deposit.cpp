...
void FixedDeposit::PrintName(std::ofstream &file) const{
    file << "FixedDeposit";
}
...
void AccumulativeDeposit::PrintName(std::ofstream &file) const{
...
void VIPDeposit::PrintName(std::ofstream &file) const{
    file << "VIPDeposit";
}
